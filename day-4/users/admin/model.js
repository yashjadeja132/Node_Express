...
// Define a Mongoose schema for the 'admins' collection
const adminSchema = new mongoose.Schema(
  {
    // Define 'admin_id' field as a required Number, unique, and use Mongoose's default feature
    admin_id: {
      type: Number,
      unique: true,
...
// Create a Mongoose model named 'AdminModel' for 'admins' collection using 'adminSchema'
